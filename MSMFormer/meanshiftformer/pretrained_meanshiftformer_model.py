...
class PretrainedMeanShiftMaskFormer(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        if self.use_embedding_loss:
            ...
            self.embedding_loss = EmbeddingLoss(alpha, delta, lambda_intra, lambda_inter, metric, normalize)
    ...
    def from_config(cls, cfg):
        ...
        return {
            ...
            # embedding loss
            "use_embedding_loss": cfg.MODEL.EMBEDDING.USE_LOSS,
            "embedding_loss_weight": cfg.MODEL.EMBEDDING.WEIGHT_LOSS,
            "alpha": cfg.MODEL.EMBEDDING.ALPHA,
            "delta": cfg.MODEL.EMBEDDING.DELTA,
            "lambda_intra": cfg.MODEL.EMBEDDING.LAMBDA_INTRA,
    ...
    def forward(self, batched_inputs):
        ...
        """
        if len(batched_inputs[0]["image"].shape)==4:
