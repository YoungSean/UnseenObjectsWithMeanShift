...
def mean_shift_with_seeds(X, Z, kappa, max_iters=10, metric='cosine', cfg_TRAIN_EMBEDDING_ALPHA=0.02):
    """ Runs mean-shift
    ...
    cluster_labels = connected_components(Z, 2 * cfg_TRAIN_EMBEDDING_ALPHA, metric=metric)  # Set epsilon = 0.1 = 2*alpha
