...
weight_path_MSMFormer = os.path.join(dirname, "../../data/checkpoints/RGB_1229_model_0017499.pth") #
# RGBD
...
weight_path_MSMFormer_crop = os.path.join(dirname, "../../data/checkpoints/crop_mixture_UCN_model_0000319.pth")
